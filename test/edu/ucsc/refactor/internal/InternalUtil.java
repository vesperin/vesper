...
//                        .append("\tint compare(Object a, Object c){ return 0; }")
  ...
  public static Source createUnknownProblemSource() {
    final String content = "\"package com.example.gcmdemo;\n" +
          "\n" +
          ...
          "    }\n" +
          "}\"";
    return createSource("MainActivity.java", new StringBuilder(content));
  }
...
//                        .append("\tvoid boom(String msg){ a = 1; if(msg.length() > 1) {}}\n")
  ...
  public static Source createStatementsOnlyCodeExample() {
    final String content = "// **** YOUR CODE **** BEGIN ****\n" +
  ...
  public static Source createFaultyUnpackedCodeExample() {
    final String content = "/** {@link Name#boom(String)} **/\tvoid boom(){ System.out.println(1); }\nvoid baam(){ System.out.println(1); }\nvoid beem(){ System.out.println(1); }\nvoid buum(){ baam(); }";
    return new Source("Scratched.java", content);
  }


  public static Source createMethodDeclarationOnlyCodeExample() {
  ...
  public static Source createSourceWithMethodOverloading() {
    final String content = "import java.io.IOException;\n" +
