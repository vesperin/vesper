...
public class SourceVisitor extends ASTVisitor {
    /**
     * Instantiates a new {@code SourceVisitor}, which won't visit
     * {@code JavaDoc} tags.
     */
    ...
    /**
     * Instantiates a new {@code SourceVisitor} with {@code visitJavadocTags} as a value.
     *
     * @param visitJavadocTags The {@code visitJavadocTags} flag.
     */
    public SourceVisitor(boolean visitJavadocTags) {
        super(visitJavadocTags);
    }


    @SuppressWarnings("UnusedParameters") protected boolean visitNode(ASTNode node) {
        return true;
    }

    @SuppressWarnings("UnusedParameters") protected void endVisitNode(ASTNode node) {
        // do nothing
    }
